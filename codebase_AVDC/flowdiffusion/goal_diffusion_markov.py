                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and self.step % self.save_and_sample_every == 0:
                        ...
                        with torch.no_grad():
                            ...
                            all_xs_list = list(map(lambda n, c, e: self.ema.ema_model.markovian_sample(batch_size=n, x_cond=c, task_embed=e, horizon=self.horizon), batches, x_conds, task_embeds))
